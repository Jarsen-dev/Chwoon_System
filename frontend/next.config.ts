  ...
  async rewrites() {
    ...
    return {
      beforeFiles: [
        ...
        { source: '/finanzas/compras/:id/aprobar/',           destination: `${BACKEND}/finanzas/compras/:id/aprobar/` },
        { source: '/finanzas/compras/:id/firmar-compras',     destination: `${BACKEND}/finanzas/compras/:id/firmar-compras` },
        { source: '/finanzas/compras/:id/firmar-compras/',    destination: `${BACKEND}/finanzas/compras/:id/firmar-compras/` },
        { source: '/finanzas/compras/:id/validar-finanzas',   destination: `${BACKEND}/finanzas/compras/:id/validar-finanzas` },
        { source: '/finanzas/compras/:id/validar-finanzas/',  destination: `${BACKEND}/finanzas/compras/:id/validar-finanzas/` },
        ...
        { source: '/calidad/inspecciones/:id/pdf/', destination: `${BACKEND}/calidad/inspecciones/:id/pdf/` },
        { source: '/calidad/inspecciones/:id/segunda-revision',  destination: `${BACKEND}/calidad/inspecciones/:id/segunda-revision` },
        { source: '/calidad/inspecciones/:id/segunda-revision/', destination: `${BACKEND}/calidad/inspecciones/:id/segunda-revision/` },
        ...
        { source: '/calidad/incidencias/:path*',    destination: `${BACKEND}/calidad/incidencias/:path*` },
