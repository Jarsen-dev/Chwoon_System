  ...
  async rewrites() {
    ...
    return {
      beforeFiles: [
        ...
        { source: '/almacen/inventario/',                     destination: `${BACKEND}/almacen/inventario/` },
        { source: '/almacen/embarques/:num/salida',           destination: `${BACKEND}/almacen/embarques/:num/salida` },
        { source: '/almacen/embarques/:num/salida/',          destination: `${BACKEND}/almacen/embarques/:num/salida/` },
        { source: '/almacen/embarques/:num/confirmar-entrega',  destination: `${BACKEND}/almacen/embarques/:num/confirmar-entrega` },
        { source: '/almacen/embarques/:num/confirmar-entrega/', destination: `${BACKEND}/almacen/embarques/:num/confirmar-entrega/` },
        { source: '/almacen/embarques',                       destination: `${BACKEND}/almacen/embarques` },
        { source: '/almacen/embarques/',                      destination: `${BACKEND}/almacen/embarques/` },
        ...
        { source: '/almacen/trazabilidad/:id/',               destination: `${BACKEND}/almacen/trazabilidad/:id/` },
        { source: '/almacen/reporte-embarques',               destination: `${BACKEND}/almacen/reporte-embarques` },
        { source: '/almacen/reporte-embarques/',              destination: `${BACKEND}/almacen/reporte-embarques/` },
