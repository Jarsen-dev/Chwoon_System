  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h2 className="text-xl font-bold text-white">🚨 Registro de Alertas y Anomalías</h2>
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <button
            ...
            className="px-3 py-1.5 rounded-full text-xs font-bold border border-gray-600 bg-gray-800 hover:bg-gray-800 text-gray-400 transition flex items-center gap-1"
          >
            🔄 Actualizar
          </button>
        </div>
            ...
            {anomalias.length === 0 ? (
              <tr>
                <td colSpan={5} className="p-16 text-center">
                  ...
                  <p className="text-gray-400 font-medium">Sin anomalías detectadas.</p>
